...
public class FantasyGoldMainNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public FantasyGoldMainNetParams() {
        super();
        interval = INTERVAL;
        targetTimespan = TARGET_TIMESPAN;
        maxTarget = Utils.decodeCompactBits(0x1d00ffffL); 
        dumpedPrivateKeyHeader = 138;
        addressHeader = 35;
        p2shHeader = 38;
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 57814;
        packetMagic = 0xd2bdf5a1; // added FGC magic the org code has 0xf9beb4d9L not matching the other forks
        bip32HeaderPub = 0x08B8D23E; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x02A7F14B; //The 4 byte header that serializes in base58 to "xprv"
        ...
        genesisBlock.setTime(1562129547L);
        genesisBlock.setNonce(1950712874);
        id = ID_FANTASYGOLD_MAINNET;
        subsidyDecreaseBlockCount = 210000; //TODO
        spendableCoinbaseDepth = 100; //TODO
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("00000000c2d6c00523c13656709668b65ab59c80c18c33ef22f2c5824542ee8c"),
                genesisHash);
        ...
        checkpoints.put(0, Sha256Hash.wrap("00000000c2d6c00523c13656709668b65ab59c80c18c33ef22f2c5824542ee8c"));
        checkpoints.put(8800, Sha256Hash.wrap("00004c2cf34f5d15ce61868d230c3c4cbc50df8feca03724e1c6d1170e8eecd6"));
        checkpoints.put(10000, Sha256Hash.wrap("a5b4947a26cbde596eb52a015a3be0733bf6192baedcf7d039ecf66a9d4672a7"));
        

        dnsSeeds = new String[] {
                "seed.fantasygold.network",         // TODO
    ...
    private static FantasyGoldMainNetParams instance;
    public static synchronized FantasyGoldMainNetParams get() {
        if (instance == null) {
            instance = new FantasyGoldMainNetParams();
        }
        return instance;
    }
