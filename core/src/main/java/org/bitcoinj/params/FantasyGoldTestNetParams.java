...
public class FantasyGoldTestNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public FantasyGoldTestNetParams() {
        super();
        interval = INTERVAL;
        targetTimespan = TARGET_TIMESPAN;
        maxTarget = Utils.decodeCompactBits(0x1f00ffffL);
        dumpedPrivateKeyHeader = 140;
        addressHeader = 95;
        p2shHeader = 88;
        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 58806;
        packetMagic = 0xf9beb4d9L;
        bip32HeaderPub = 0x0845C3F8; //The 4 byte header that serializes in base58 to "xpub".
        bip32HeaderPriv = 0x03654388; //The 4 byte header that serializes in base58 to "xprv"
        ...
        genesisBlock.setTime(1561661716L);
        genesisBlock.setNonce(11077);
        id = ID_FANTASYGOLD_TESTNET;
        subsidyDecreaseBlockCount = 210000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("00005d862c9ec18e7e3ba01062a9451ace7fc4da888d5a0817de199726477e9a"),
                genesisHash);
        ...
        checkpoints.put(0, Sha256Hash.wrap("00005d862c9ec18e7e3ba01062a9451ace7fc4da888d5a0817de199726477e9a"));
        

        dnsSeeds = new String[] {
                "testnet.fantasygold.network",         // TODO
    ...
    private static FantasyGoldTestNetParams instance;
    public static synchronized FantasyGoldTestNetParams get() {
        if (instance == null) {
            instance = new FantasyGoldTestNetParams();
        }
        return instance;
    }
